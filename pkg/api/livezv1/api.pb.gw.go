...
/*
Package livezv1 is a reverse proxy.
...
// RegisterLivezAPIHandlerServer registers the http handlers for service LivezAPI to "mux".
// UnaryRPC     :call LivezAPIServer directly.
...
// RegisterLivezAPIHandlerFromEndpoint is same as RegisterLivezAPIHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterLivezAPIHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterLivezAPIHandler(ctx, mux, conn)
}

// RegisterLivezAPIHandler registers the http handlers for service LivezAPI to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterLivezAPIHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterLivezAPIHandlerClient(ctx, mux, NewLivezAPIClient(conn))
}

// RegisterLivezAPIHandlerClient registers the http handlers for service LivezAPI
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "LivezAPIClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "LivezAPIClient"
