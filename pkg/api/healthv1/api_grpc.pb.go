...
func (c *healthAPIClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	out := new(HealthCheckResponse)
	err := c.cc.Invoke(ctx, "/iamnande.cardmod.health.v1.HealthAPI/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHealthAPIServer) Check(context.Context, *HealthCheckRequest) (*HealthCheckResponse, error) {
...
func _HealthAPI_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iamnande.cardmod.health.v1.HealthAPI/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthAPIServer).Check(ctx, req.(*HealthCheckRequest))
	}
...
var HealthAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "iamnande.cardmod.health.v1.HealthAPI",
	...
	Metadata: "iamnande/cardmod/health/v1/api.proto",
}
