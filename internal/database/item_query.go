...
func (igb *ItemGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(igb.fields) > 1 {
		return nil, errors.New("database: ItemGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := igb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (igb *ItemGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{item.Label}
	default:
		err = fmt.Errorf("database: ItemGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (igb *ItemGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(igb.fields) > 1 {
		return nil, errors.New("database: ItemGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := igb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (igb *ItemGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{item.Label}
	default:
		err = fmt.Errorf("database: ItemGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (igb *ItemGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(igb.fields) > 1 {
		return nil, errors.New("database: ItemGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := igb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (igb *ItemGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{item.Label}
	default:
		err = fmt.Errorf("database: ItemGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (igb *ItemGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(igb.fields) > 1 {
		return nil, errors.New("database: ItemGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := igb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (igb *ItemGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{item.Label}
	default:
		err = fmt.Errorf("database: ItemGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (is *ItemSelect) Strings(ctx context.Context) ([]string, error) {
	if len(is.fields) > 1 {
		return nil, errors.New("database: ItemSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := is.Scan(ctx, &v); err != nil {
		return nil, err
...
func (is *ItemSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{item.Label}
	default:
		err = fmt.Errorf("database: ItemSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (is *ItemSelect) Ints(ctx context.Context) ([]int, error) {
	if len(is.fields) > 1 {
		return nil, errors.New("database: ItemSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := is.Scan(ctx, &v); err != nil {
		return nil, err
...
func (is *ItemSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{item.Label}
	default:
		err = fmt.Errorf("database: ItemSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (is *ItemSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(is.fields) > 1 {
		return nil, errors.New("database: ItemSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := is.Scan(ctx, &v); err != nil {
		return nil, err
...
func (is *ItemSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{item.Label}
	default:
		err = fmt.Errorf("database: ItemSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (is *ItemSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(is.fields) > 1 {
		return nil, errors.New("database: ItemSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := is.Scan(ctx, &v); err != nil {
		return nil, err
...
func (is *ItemSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{item.Label}
	default:
		err = fmt.Errorf("database: ItemSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
